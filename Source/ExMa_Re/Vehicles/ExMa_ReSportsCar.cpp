...
#include "ExMa_ReSportsCar.h"
#include "ExMa_Re/Wheels/Sport/ExMa_ReSportsWheelFront.h"
#include "ExMa_Re/Wheels/Sport/ExMa_ReSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AExMa_ReSportsCar::AExMa_ReSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UExMa_ReSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UExMa_ReSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UExMa_ReSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UExMa_ReSportsWheelRear::StaticClass();
